...
class DetectLiquidScriptTypeUsecase {
  ...
  /// Detects the correct script type for a Liquid wallet by checking for BIP49 funds.
  ///
  /// Returns [ScriptType.bip49] if Aqua wallet funds are detected,
  /// otherwise returns [ScriptType.bip84] (modern standard).
